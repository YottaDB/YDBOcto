...
Errors in Octo are of the form :code:`ERR_<error>` or :code:`INFO_<error>`. The errors are detailed below, in alphabetical order. Occurrences of "xxx" indicate portions of the error message text that vary depending on the details of the particular error.
...
Errors in Rocto are of the form :code:`ERR_ROCTO_<error>` or :code:`INFO_ROCTO_<error>`. The errors are detailed below, in alphabetical order. Occurrences of "xxx" indicate portions of the error message text that vary depending on the details of the particular error.
