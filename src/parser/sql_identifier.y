...
sql_identifier_minus_more
  ...
  | DELIMS { SQL_VALUE_STATEMENT($$, STRING_LITERAL, "delims"); }
  ...
  | ITERATOR { SQL_VALUE_STATEMENT($$, STRING_LITERAL, "iterator"); }
  ...
  | OPERATOR { SQL_VALUE_STATEMENT($$, STRING_LITERAL, "operator"); }
  ...
  | PIECES { SQL_VALUE_STATEMENT($$, STRING_LITERAL, "pieces"); }
  ...
  | SUBSTR { SQL_VALUE_STATEMENT($$, STRING_LITERAL, "substr"); }
  ...
  | VIRTUAL { SQL_VALUE_STATEMENT($$, STRING_LITERAL, "virtual"); }
