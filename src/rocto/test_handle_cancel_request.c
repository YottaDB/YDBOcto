...
int __wrap_get_pid_start_time(pid_t pid) {
	return mock_type(int);
}
...
int main(void) {
	...
	const struct CMUnitTest tests[] = {
		   cmocka_unit_test(test_valid_cancel_request),
		   cmocka_unit_test(test_bad_pid),
		   cmocka_unit_test(test_bad_timestamp),
		   cmocka_unit_test(test_bad_secret_key),
		   cmocka_unit_test(test_kill_failure),
	};
