...
static void test_valid_input_one_parm(void **state) {
	...
	short int formats[1] = {5};			// arbitrary format code
	...
	message_length += sizeof(short int);
	short int col_formats[1] = {5};			// arbitrary col format code
...
static void test_valid_input_multi_parms(void **state) {
	// Test a valid, simple, Bind command
	int message_length = 0;
	message_length += sizeof(unsigned int);		// length
	...
	message_length += sizeof(short int);
	short int formats[2] = {5, 2};			// arbitrary format code
	message_length += sizeof(formats);
	...
	message_length += sizeof(short int);
	short int col_formats[2] = {5, 2};			// arbitrary col format code
	message_length += sizeof(col_formats);
...
int main(void) {
	const struct CMUnitTest tests[] = {
		...
		cmocka_unit_test(test_valid_input_multi_parms),
