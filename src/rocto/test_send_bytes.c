...
int main(void) {
	...
	const struct CMUnitTest tests[] = {
		...
		cmocka_unit_test(test_send_connection_reset),
		cmocka_unit_test(test_send_broken_pipe),
		cmocka_unit_test(test_send_timed_out),
		cmocka_unit_test(test_valid_input_with_SSL),
		cmocka_unit_test(test_connection_reset_with_SSL),
		cmocka_unit_test(test_SSL_write_interrupted),
		cmocka_unit_test(test_SSL_ERROR_ZERO_RETURN),
		cmocka_unit_test(test_SSL_ERROR_WANT_WRITE),
		cmocka_unit_test(test_SSL_ERROR_SYSCALL),
