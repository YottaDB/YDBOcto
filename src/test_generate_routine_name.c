...
static void test_valid_input_cross_reference(void **state) {
	...
	generate_routine_name(&hash_state, routine_name, MAX_ROUTINE_LEN, CrossReference);
...
static void test_valid_input_output_plan(void **state) {
	...
	generate_routine_name(&hash_state, routine_name, MAX_ROUTINE_LEN, OutputPlan);
	buf_size = strlen(routine_name);
...
static void test_valid_input_trigger_plan(void **state) {
	...
	generate_routine_name(&hash_state, routine_name, MAX_TRIGGER_LEN, YDBTrigger);
	buf_size = strlen(routine_name);
