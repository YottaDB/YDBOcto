...
CREATE TABLE tmp (id INTEGER PRIMARY KEY, firstName VARCHAR(30), lastName VARCHAR(30), computed VARCHAR EXTRACT "$$CONCAT^%ydboctofCONCAT(keys(""ID""),values(""FIRSTNAME""),keys(""LASTNAME""))") GLOBAL "^names";
