...
genDateHorolog();
	; -365 (01-JAN-1840) to 2980013 (31-DEC-9999)
	quit $random(2980013+365+1)-365
genTimeHorolog();
	; 0 (00:00:00) to 86399 (23:59:59)
	quit $random(86399+1)
genTimestampHorolog();
	; -365,0 (01-JAN-1840 00:00:00) to 2980013,86399 (31-DEC-9999 23:59:59)
	quit $$genDateHorolog_","_$$genTimeHorolog

genDateFileman();
	; 0010101 (01-JAN-1701) to 9991231 (31-DEC-2699)
...
genDateZHorolog();
	; -365,,, to 2980013,,, (01-JAN-1840 to 31-DEC-9999)
...
genTimestampZHorolog();
	; -365,0,[0], to 2980013,86399,[999999], (01-JAN-1840 00:00:00.000000 to 31-DEC-9999 23:59:59.999999)
	quit $$genDateOnlyZHorolog_","_$$genSecondOnlyZHorolog_","_$$genZHorologMicroSecond_","
genTimestampWithTimeZoneZHorolog();
	; -365,0,[0],43200 to 2980013,86399,[999999],-50400 (01-JAN-1840 00:00:00.000000-12:00 to 31-DEC-9999 23:59:59.999999+14:00)
...
genDateOnlyFileman()
	quit $$genNum($random(999)+1,3)_$$genNum($random(12)+1,2)_$$genNum($random(31)+1,2)
...
genDateOnlyZUT()
	quit $random(2534022144+1+621672192)-621672192
