...
SELECT c.CustomerID,MAX(o.OrderID),COUNT(o.OrderID) FROM Customers c INNER JOIN Orders o ON c.CustomerID = o.CustomerID GROUP BY c.CustomerID ORDER BY MAX(ABS(10429-o.OrderID)) DESC, c.CustomerID;
SELECT c.CustomerID,MAX(o.OrderID),COUNT(o.OrderID) FROM Customers c LEFT JOIN Orders o ON c.CustomerID = o.CustomerID GROUP BY c.CustomerID ORDER BY MAX(ABS(10429-o.OrderID)) DESC, c.CustomerID;
SELECT c.CustomerID,MAX(o.OrderID),COUNT(o.OrderID) FROM Customers c RIGHT JOIN Orders o ON c.CustomerID = o.CustomerID GROUP BY c.CustomerID ORDER BY MAX(ABS(10429-o.OrderID)) DESC, c.CustomerID;
SELECT c.CustomerID,MAX(o.OrderID),COUNT(o.OrderID) FROM Customers c FULL JOIN Orders o ON c.CustomerID = o.CustomerID GROUP BY c.CustomerID ORDER BY MAX(ABS(10429-o.OrderID)) DESC, c.CustomerID;
SELECT COUNT(c.CustomerID),COUNT(o.OrderID),c.CustomerID FROM Customers c INNER JOIN Orders o ON c.CustomerID = o.CustomerID GROUP BY c.CustomerID ORDER BY COUNT(o.OrderID) DESC, c.CustomerID;
SELECT COUNT(c.CustomerID),COUNT(o.OrderID),c.CustomerID FROM Customers c LEFT JOIN Orders o ON c.CustomerID = o.CustomerID GROUP BY c.CustomerID ORDER BY COUNT(o.OrderID) DESC, c.CustomerID;
SELECT COUNT(c.CustomerID),COUNT(o.OrderID),c.CustomerID FROM Customers c RIGHT JOIN Orders o ON c.CustomerID = o.CustomerID GROUP BY c.CustomerID ORDER BY COUNT(o.OrderID) DESC, c.CustomerID;
SELECT COUNT(c.CustomerID),COUNT(o.OrderID),c.CustomerID FROM Customers c FULL JOIN Orders o ON c.CustomerID = o.CustomerID GROUP BY c.CustomerID ORDER BY COUNT(o.OrderID) DESC, c.CustomerID;

--> Test HAVING with GROUP BY
SELECT c.CustomerID,MAX(o.OrderID),COUNT(o.OrderID) FROM Customers c LEFT JOIN Orders o ON c.CustomerID = o.CustomerID GROUP BY c.CustomerID HAVING COUNT(o.OrderID) BETWEEN 5 and 10 ORDER BY MAX(ABS(10429-o.OrderID)) DESC, c.CustomerID;
