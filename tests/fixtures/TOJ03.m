...
genrandomqueries	;
	...
	set columns("orders","order_date","date'1776-07-04'")=""
	set columns("orders","order_date","date'1760-03-14'")=""
	set columns("orders","order_date","date'1784-05-23'")=""
	set columns("orders","order_date","date'1790-09-03'")=""
	set columns("orders","order_date","date'1795-07-21'")=""
	set columns("orders","order_date","date'1787-11-27'")=""
