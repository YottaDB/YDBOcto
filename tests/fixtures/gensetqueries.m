...
genfixedsetqueries	;
	...
	set query($incr(query))="(select firstname from names where id = 1 or id = 2 order by firstname limit 2) union (select firstname from names where id > 3 OR id = 1 order by firstname limit 3);"
	set query($incr(query))="(select firstname from names where id > 3 OR id = 1 order by firstname limit 3) union (select firstname from names where id = 1 or id = 2 order by firstname limit 2);"
	set query($incr(query))="(select firstname from names where id = 1 or id = 2 limit 2) union (select firstname from names where id > 3 OR id = 1 limit 3);"
	set query($incr(query))="(select firstname from names where id > 3 OR id = 1 limit 3) union (select firstname from names where id = 1 or id = 2 limit 2);"
	...
	set query($incr(query))="(select firstname from names where id = 1 or id = 2 order by firstname limit 2) union (select firstname from names where id > 3 OR id = 1 order by firstname limit 2);"
	set query($incr(query))="(select firstname from names where id > 3 OR id = 1 order by firstname limit 2) union (select firstname from names where id = 1 or id = 2 order by firstname limit 2);"
	set query($incr(query))="(select firstname from names order by firstname) union (select firstname from names where id > 3 OR id = 1 order by firstname limit 2);"
	set query($incr(query))="(select firstname from names where id > 3 OR id = 1 order by firstname limit 2) union (select firstname from names order by firstname);"
	...
	set query($incr(query))="(select firstname from names where id = 1 or id = 2 order by firstname) union (select firstname from names where id > 3 OR id = 1 order by firstname limit 2);"
	set query($incr(query))="(select firstname from names where id > 3 OR id = 1 order by firstname limit 2) union (select firstname from names where id = 1 or id = 2 order by firstname);"
	...
	set query($incr(query))="(select firstname from names where id = 1 or id = 2 limit 2) union (select firstname from names where id > 3 OR id = 1 limit 2);"
	set query($incr(query))="(select firstname from names where id > 3 OR id = 1 limit 2) union (select firstname from names where id = 1 or id = 2 limit 2);"
	set query($incr(query))="(select firstname from names) union (select firstname from names where id > 3 OR id = 1 limit 2);"
	set query($incr(query))="(select firstname from names where id > 3 OR id = 1 limit 2) union (select firstname from names);"
	...
	set query($incr(query))="(select firstname from names where id = 1 or id = 2) union (select firstname from names where id > 3 OR id = 1 limit 2);"
	set query($incr(query))="(select firstname from names where id > 3 OR id = 1 limit 2) union (select firstname from names where id = 1 or id = 2);"
