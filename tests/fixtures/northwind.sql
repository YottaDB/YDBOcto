...
CREATE TABLE Suppliers (SupplierID INTEGER PRIMARY KEY, SupplierName VARCHAR(48), ContactName VARCHAR(32), Address VARCHAR(64), City VARCHAR(32), PostalCode VARCHAR(16) MAYBE_CANONICAL, Country VARCHAR(32), Phone VARCHAR(15) MAYBE_CANONICAL) GLOBAL "^Suppliers";
