...
skiplist="COPYING README.md LICENSE tests/fixtures/TSPEED006.sql tests/fixtures/TSPEED007.sql tools/ci/postgres-rocky/NOTICE tools/ci/postgres-rocky/postgresql-setup tools/ci/postgres-rocky/postgresql.conf cmake/git-watcher.cmake"
